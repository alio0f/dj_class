...
class product(models.Model):
    ...
    product_info = models.OneToOneField(ProductInformation,on_delete=models.CASCADE,null=True,blank=True,verbose_name='اطلاعات')
    product_tag = models.ManyToManyField(ProductTag,verbose_name='محصول')
    title = models.CharField(max_length=100,verbose_name='محصولات')
